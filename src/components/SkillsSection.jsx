            ...
            <div className='skills-container'>
                ...
                <div className='skills-cards'>
                    <div className='flex flex-col md:flex-row gap-5 md:gap-10 justify-center'>
                        <AnimateOnScroll animation='fade-right' delay={300} threshold={0.3}>
                            <div className='skill-card'> 
                                <div className='skill-card-heading'>
                                    <img src={figmaIcon} alt="figma" className='h-[40px] md:h-[65px]' loading="lazy" />
                        ...
                        <AnimateOnScroll animation='fade-left' delay={300} threshold={0.3}>
                        <div className='skill-card'>
                            <div className='skill-card-heading'>
                                <img src={canvaIcon} alt="canva" className='h-[40px] md:h-[65px]' loading="lazy"/>
                    ...
                    <div className='self-center'>
                        <AnimateOnScroll animation='fade-up' delay={400} threshold={0.3}>
                            <div className='skill-card'>
                                <div className='skill-card-heading'>
                                    <img src={reactIcon} alt="react" className='h-[40px] md:h-[65px]' loading="lazy"/>
                                    <img src={flutterIcon} alt="flutter" className='h-[40px] md:h-[65px]' loading="lazy"/>
                                </div>
