    ...
    <section id='hero' className='main-section'>
      <div className='main-section-container'>
        ...
        <div className='relative w-full h-[550px] md:h-[650px]'>
          <AnimateOnScroll animation='fade-in' delay={400} threshold={0.3}>
            <img src={person} alt="Sev" className='absolute top-[65px] md:top-6 right-[90px] md:right-24 z-20 md:w-[600px] h-[470px] md:h-[600px]' loading="lazy"/>
          </AnimateOnScroll>
          <AnimateOnScroll animation='zoom-in' delay={100} threshold={0.3}>
            <img src={diamondBG} className='absolute top-[-100px] md:top-[-82px] z-0 w-[750px] h-[750px]' loading="lazy"/>
          </AnimateOnScroll>
        </div>
      </div>
    </section>
